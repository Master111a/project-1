    ...
    return (
        <div className="flex w-full items-center justify-center lg:justify-start">
            <div className="flex flex-col gap-y-6 lg:gap-y-11 h-auto">
                ...
                <h1 className="text-3xl lg:text-4xl xl:text-69 leading-1.2 text-center lg:text-left text-wrap font-bold">
                    Travel{" "}
                ...
                <p className="text-base lg:text-lg leading-[1.6] text-textDesc/50 text-center lg:text-justify">
