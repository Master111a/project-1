        ...
        <div className="flex w-full items-center">
            <div className="flex flex-col gap-y-6 lg:gap-y-11 h-auto">
                <div className="flex items-center ">
                    <Button className="group bg-white text-strongTextColor w-auto hover:bg-strongTextColor hover:text-white">
                ...
                <div className="flex items-center">
                    <Button
                        className="text-white bg-buttonColor hover:bg-buttonColor/75 drop-shadow-3 text-sm"
                        title="Get Started"
                    />
                    <Button className="bg-transparent animate-wiggle text-textLinkColor border-[#eeeeee] border">
