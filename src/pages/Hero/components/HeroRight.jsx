...
export default function HeroRight() {
    return (
        <div className="flex flex-col xl:flex-row w-full relative justify-center lg:items-end">
            <img
                src={layer}
                alt="layer"
                className="z-0 w-full object-contain xl:absolute top-0 right-0 left-0 "
            />
            <div className="flex justify-center w-full lg:items-end z-[1] -translate-y-8 sm:-translate-y-32 lg:-translate-y-1/4 xl:translate-y-0">
                <div className="flex flex-col sm:flex-row gap-8 w-full lg:w-auto">
                    <div className="flex flex-col gap-y-8 w-full sm:w-1/2 items-center sm:items-end lg:items-center">
                        <ImageCard
                            src={hero1}
                            className="relative h-272 w-4/5 sm:w-272 sm:h-300"
                            rounded="rounded-32">
                        ...
                        <ImageCard
                            src={hero2}
                            className="relative h-272 w-4/5 sm:w-272 sm:h-300 overflow-hidden"
                            rounded="rounded-32"
                        />
                    </div>
                    <div className="flex sm:flex-col w-full sm:w-1/2 justify-center relative">
                        <ImageCard
                            src={hero3}
                            className="relative h-272 w-4/5 sm:w-272 sm:h-400"
                            rounded="rounded-32">
